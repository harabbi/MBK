...
MBK_MAGENTO_HOST        = ENV["MBK_MAGENTO_HOST"]
MBK_MAGENTO_USER        = ENV["MBK_MAGENTO_USER"]
MBK_MAGENTO_PASS        = ENV["MBK_MAGENTO_PASS"]
MBK_MAGENTO_DATA_DIR    = ENV["MBK_MAGENTO_DATA_DIR"]

MBK_MAGENTO_SSH_HOST    = ENV["MBK_MAGENTO_SSH_HOST"]
MBK_MAGENTO_SSH_USER    = ENV["MBK_MAGENTO_SSH_USER"]
MBK_MAGENTO_SSH_PASS    = ENV["MBK_MAGENTO_SSH_PASS"]
