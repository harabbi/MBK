...
concat(productname,' ',productdescriptionshort,' VOLUSION DESCRIPTION ISSUE')     as `v_productdescription`,
...
discountedprice_level1  as `v_discountedprice_level1`,
...
concat(productname,' ',productdescriptionshort,' VOLUSION DESCRIPTION ISSUE')     as `m_description`,
...
discountedprice_level1  as `m__tier_price_price`,
