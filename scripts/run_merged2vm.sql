	...
	"base",
    `m_name`, 
  CASE WHEN LENGTH(`m_description`) = 0 THEN "NONE" ELSE `m_description` END, 
  CASE WHEN LENGTH(`m_short_description`) = 0 THEN "NONE" ELSE `m_short_description` END, 
	round(`m_price`,2),
	NULL,
	NULL,
	NULL,
  ...
  REPLACE(`m_meta_description`,'"',''),   
	...
	NULL,
	NULL,
  CASE WHEN LENGTH(`m_mbk_features_area`) = 0 THEN "NONE" ELSE `m_mbk_features_area` END,
	NULL,
